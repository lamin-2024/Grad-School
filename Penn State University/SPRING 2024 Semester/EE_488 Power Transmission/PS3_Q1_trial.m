...
tol = 0.0001;  err = 1; old2 = V(2); old3 = V(3); count = 0; mag_source = abs(V(1));

%________________ Iteration loop___________________
while (err>tol)
    count = count+1;
    P = [0 P1(1,2) P1(1,3)];  Q = [0 Q1(1,2) Q1(1,3)];
    for k=1:3
        for n=1:3
    ...
    P(2) = P1(1,2); Q(2) = Q1(1,2);  %this set the fix P and Q values @ bus 2
    P(3) = P1(1,3); Q(3) = Q1(1,3);  %this sets the fix P and Q value @ bus 3
    ...
    V(1) = mag_source*V(1)/abs(V(1));  %this retains the mag of voltage source bus
    err2 = abs((V(2)-old2)/old2);
    old2 = V(2);
    err3 = abs((V(3)-old3)/old3);
    old3 = V(3);
    err = err2 & err3
end
