...
$tempAcq setState "!VA&!VB&!OUT"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VA VB OUT:out } { initial_delay units ct default_slew gate_leakage_multiplication_factor trailing_delay pp }
...
$tempWT addMeasurements {} {
  { leakage_current      leakage_power { (0)+initial_delay+(gate_leakage_multiplication_factor*pp) (0)+initial_delay+(gate_leakage_multiplication_factor*pp)+pp {VA VB} {} } NO_USER SYS }
}

$tempWT bindInterface { VA VB OUT } { cell_initial_delay None[cycle_time] None[cycle_time] None[default_slew] gate_leakage_time_scaling_factor cell_trailing_delay cell_power_period }
