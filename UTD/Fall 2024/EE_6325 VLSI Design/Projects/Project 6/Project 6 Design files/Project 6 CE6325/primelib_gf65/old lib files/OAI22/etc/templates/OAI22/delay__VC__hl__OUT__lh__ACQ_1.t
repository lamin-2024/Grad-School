...
# Host Name: engnx03a.utdallas.edu, User Name: dal852207, PID: 19533 #
# Directory: /home/eng/d/dal852207/cad/gf65/primelib_gf65 #
# Date Sat, 23 Nov 2024 12:51:30 CST #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {VA VB VC VD VSS VDD OUT}
...
## 
## Test delay__VC__hl__OUT__lh
set tempTest [ SBTest "delay__VC__hl__OUT__lh" ]
$tempTest setTargets { delay__VC__hl__OUT__lh Cin__VC__hl Tout__OUT__lh cap_energy__OUT__lh energy1__VC__hl__OUT__lh__VDD energy__VC__hl__OUT__lh leakage_power1__VDD leakage_power2__VDD }
...
$tempAcq setState "VB&!VA&!VD"
$tempAcq setStateCoverage "1"
$tempAcq setAdditionalStateCoverage "1" "leakage_power1__VDD"
$tempAcq setAdditionalStateCoverage "1" "energy1__VC__hl__OUT__lh__VDD"
$tempAcq setAdditionalStateCoverage "1" "energy__VC__hl__OUT__lh"
...
$tempWT setInterface { VA VB VC VD OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   VA   VB   VC   VD   OUT   } {
                   "0"            {} {   0    1    1    0    Z,0   }
...
$tempWT addMeasurements {} {
  { tin_VC               Tin        { VC start } NO_USER SYS }
  { cin_VC               Cin        { VC start } NO_USER SYS }
  { tout_OUT             Tout       { OUT out } NO_USER SYS }
  { delay_VC_OUT         delay      { VC start OUT out } NO_USER SYS }
  { energy__VC__hl__OUT__lh energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__VC__hl__OUT__lh__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
...
$tempWT bindInterface { VA VB VC VD OUT } { 10e-12 VC[cycle_time] VC[cycle_time] VC[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
