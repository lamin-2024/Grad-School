if { [catch {
set_location /home/eng/d/dal852207/cad/gf65/primelib_gf65/XOR2
...
set_config_opt -- cdpl_log_subdir pid28235
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/d/dal852207/cad/gf65/primelib_gf65/XOR2/runtime/cdpl/pid28235} mv_err] } {
      log_warning $mv_err
    }
  } else {
