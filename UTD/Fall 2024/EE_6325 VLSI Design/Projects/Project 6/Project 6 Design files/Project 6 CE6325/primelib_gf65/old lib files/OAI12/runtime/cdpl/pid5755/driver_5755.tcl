if { [catch {
set_location /home/eng/d/dal852207/cad/gf65/primelib_gf65/OAI12
...
set_config_opt -- cdpl_log_subdir pid5755

create_parameter configure_arc_based
set_config_opt -cell OAI12 -- configure_arc_based 0
...
set_config_opt -- source_from_instance NAND3
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/d/dal852207/cad/gf65/primelib_gf65/OAI12/runtime/cdpl/pid5755} mv_err] } {
      log_warning $mv_err
    }
  } else {
