...
$tempAcq setState "!OUT&!VA&!VB&!VC&!VD&!VSS"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VA VB VC VD VSS VDD } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   VA   VB   VC   VD   VSS  VDD   } {
                   "0"      {} {   0    0    0    0    0    0     }
       "initial_delay" { in1 } {   -    -    -    -    -    1     }
"(initial_delay)+(pp)"      {} {   -    -    -    -    -    -     }
}
...
$tempWT bindInterface { VA VB VC VD VSS VDD } { 10e-12 VDD[cycle_time] VDD[cycle_time] VDD[default_slew] cell_power_period }
