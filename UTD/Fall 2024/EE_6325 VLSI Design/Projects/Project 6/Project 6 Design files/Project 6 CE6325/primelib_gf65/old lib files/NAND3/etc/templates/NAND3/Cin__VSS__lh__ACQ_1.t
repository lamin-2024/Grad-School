...
$tempAcq setState "!OUT&!VA&!VB&!VC&!VDD"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VA VB VSS VDD VC } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   VA   VB   VSS  VDD  VC    } {
                   "0"      {} {   0    0    0    0    0     }
       "initial_delay" { in1 } {   -    -    1    -    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -    -     }
}
...
$tempWT bindInterface { VA VB VSS VDD VC } { 10e-12 VSS[cycle_time] VSS[cycle_time] VSS[default_slew] cell_power_period }
