...
# Host Name: engnx01a.utdallas.edu, User Name: dal852207, PID: 4950 #
# Directory: /home/eng/d/dal852207/cad/gf65/primelib_gf65 #
# Date Sat, 09 Nov 2024 22:32:08 CST #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {VA VB VSS VDD OUT}
...
## 
## Test delay__VA__hl__OUT__hl
set tempTest [ SBTest "delay__VA__hl__OUT__hl" ]
$tempTest setTargets { delay__VA__hl__OUT__hl Cin__VA__hl Tout__OUT__hl cap_energy__OUT__hl energy1__VA__hl__OUT__hl__VDD energy__VA__hl__OUT__hl leakage_power1__VDD leakage_power2__VDD }
...
$tempAcq setAdditionalStateCoverage "1" "energy__VA__hl__OUT__hl"
$tempAcq setAdditionalStateCoverage "1" "energy1__VA__hl__OUT__hl__VDD"
$tempAcq setDoEcsmSi 0

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VA VB OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   VA   VB   OUT   } {
                   "0"            {} {   1    0    Z,1   }
...
$tempWT addMeasurements {} {
  ...
  { energy__VA__hl__OUT__hl energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__VA__hl__OUT__hl__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
...
$tempWT bindInterface { VA VB OUT } { 10e-12 VA[cycle_time] VA[cycle_time] VA[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
