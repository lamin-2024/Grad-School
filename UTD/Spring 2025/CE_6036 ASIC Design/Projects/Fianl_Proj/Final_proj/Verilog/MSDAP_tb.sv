...
#2  Start=0;
    ...
    fd = $fopen("/home/eng/t/txg150930/workspace/ASIC/sim/data1.in", "r");
    if(fd) 
  ...
  initial begin
    fd2 = $fopen("/home/eng/t/txg150930/workspace/ASIC/sim/data1.out", "r");    
    if(fd2) 
        $display("Successfully read in data1.out.");
    else begin
        $display("Failed to read in data1.out.");
        $finish;
    end
    outL<=0; outR<=0;
    repeat(6393) begin
